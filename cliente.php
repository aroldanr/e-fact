...
$unique_prefix = "cliente_"; /* prevent overlays - must be started with a letter */
...
$sql = "SELECT id, ingreso_cliente, ruc_cliente, nombre1_cliente, nombre2_cliente, apellido1_cliente, apellido2_cliente, CONCAT_WS(' ', nombre1_cliente, nombre2_cliente, apellido1_cliente, apellido2_cliente) AS nombre_cliente, telefono_cliente, direccion_cliente, correo_cliente, estado_cliente FROM cliente";
$default_order = array(
    "nombre1_cliente" => "ASC",
    "apellido1_cliente" => "ASC"
...
$dg_caption = "<h2 style='margin-top: 20px;'>CATÁLOGO DE CLIENTES</h2>";
...
$em_columns = array(
    ...
    "direccion_cliente" => array(
        "header" => "Direcci&oacute;n Exacta",
        "type" => "textarea",
        "req_type" => "sy",
        "width" => "410px",
        "title" => "",
