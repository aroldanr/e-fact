				...
				<ul class="nav nav-pills nav-stacked custom-nav">
					...
					<li class="menu-list"><a href="#"><i class="lnr lnr-cog"></i> <span>Procesos</span></a>
						<ul class="sub-menu-list">
							<li><a href="registrofacturasvendedor.php">Registro Factura</a></li>
						</ul>
					</li>
				</ul>
				<!--<ul class="nav nav-pills nav-stacked custom-nav">
					...
					<li class="menu-list"><a href="#"><i class="lnr lnr-printer"></i> <span>Reportes</span></a>
						<ul class="sub-menu-list">
							<li><a href="#">Facturaci&oacute;n por per&iacute;odos</a></li>
							<li><a href="#">Listado de Clientes</a></li>
							<li><a href="#">Listado de Proveedores</a></li>
							<li><a href="#">Listado de Vendedores</a></li>
						</ul></li>
					<li><a href="usuario.php"><i class="lnr lnr-user"></i> <span>Usuarios</span></a></li>	
				</ul>-->
				<!--sidebar nav end-->
			</div>
		</div>
