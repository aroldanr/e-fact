...
$sql = "SELECT
            ...
            enc_venta.numero,
            enc_venta.fecha,
            enc_venta.id_cliente,
            CONCAT_WS(' ', cliente.nombre1_cliente, cliente.nombre2_cliente, cliente.apellido1_cliente, cliente.apellido2_cliente) AS nombre_cliente
        FROM
            enc_venta
        INNER JOIN cliente ON enc_venta.id_cliente = cliente.id
        WHERE enc_venta.id_vendedor = ".$id_vendedor;
$default_order = array(
    "enc_venta.numero" => "DESC",
    "enc_venta.fecha" => "DESC"
);
...
$dg_caption = "<h2 style='margin-top: 20px;'>REGISTRO DE FACTURAS</h2>";
...
$table_name = "enc_venta";
$primary_key = "id";
$condition = "id_vendedor = ".$id_vendedor;
...
$foreign_keys = array(
    "id_cliente" => array(
        "table" => "cliente",
        "field_key" => "id",
        "field_name" => "CONCAT_WS(' ', nombre1_cliente, nombre2_cliente, apellido1_cliente, apellido2_cliente) AS nombre_cliente",
        "view_type" => "dropdownlist",
        "order_by_field" => "nombre_cliente",
        "order_type" => "ASC"
    )
);
...
if ($mode == "edit") {
    ...
    $sql = "SELECT
            ...
            FROM
                det_venta
            INNER JOIN articulo ON det_venta.id_articulo = articulo.id
            WHERE det_venta.id_enc_venta = " . $dgrid->GetCurrentId() . " ";
    $default_order = array(
        "id" => "DESC"
    );
    ...
    // # *** set DataGrid caption
    $dg_caption = "<h4 style='margin-top: 50px;'>DETALLE DE VENTAS POR PRODUCTOS</h4>";
    ...
    // # *** set settings for add/edit/details modes
    $table_name = "det_venta";
    $primary_key = "id";
    $condition = "det_venta.id_enc_venta = " . $dgrid->rid . " ";
